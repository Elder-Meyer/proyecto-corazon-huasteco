        ...
        <Box sx={{bgcolor: "primary.main", flexGrow:1, mt:5}}>
            <Grid container spacing={5}>
                ...
                <Grid item md={4} sm={6} xs={12}>
                    <Box ml={5}>
                        <Typography variant="h6" component="p" sx={{color:'background.paper'}}>Categorias</Typography>
                ...
                <Grid item md={4} sm={6} xs={12}>
                    <Box ml={5}>
                        <Typography variant="h6" component="p" sx={{color:'background.paper'}}>Sobre nosotros</Typography>
                        <Typography variant='body1' className="footer-menu">
                ...
                <Grid item md={4} sm={12} xs={12}>
                    <Box ml={5}>
                        <Typography variant="h6" component="p" sx={{color:'background.paper'}}>Soporte</Typography>
