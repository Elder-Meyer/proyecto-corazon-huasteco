...
export const DetalleProduct = () => {
  ...
  return (
    <WrapperSingleRoute>
        ...
        >
            <Grid item xs > 
                <Bread migas={[{miga: "INICIO", ruta: "/inicio"},{miga: "TIENDA", ruta: "/tienda"},{miga: "PRODUCTO", ruta: "/tienda/:id"}]}/>
            </Grid>
        </Grid>
        ...
        <Grid container spacing={3}>
            <Grid item xs={12} md={7}>
                <ItemListCard 
                    img={'https://firebasestorage.googleapis.com/v0/b/corazon-huasteco-bfbcc.appspot.com/o/a1.jpg?alt=media&token=57a1ec8a-7e22-4298-99de-5f18a47c4dc3'}
                    heightImg={500}
                    showContent={false}
                />
            ...
            <Grid item xs={12} md={5}>
                <Paper sx={{p:1, m:2}}>
                    ...
                    <Typography variant='body1' textAlign="right" component="p" fontWeight="10">
                    ...
                    <Box textAlign="center" p={3}>
                        <Typography fontWeight="bold" textAlign="left">Categorias:</Typography>
                        <Chip label="Artesania" color="primary" variant="outlined" sx={{mr:1}} />
                        <Chip label="Tradicional" color="primary" variant="outlined" sx={{mr:1}}/>
                        <Chip label="Regional" color="primary" variant="outlined" sx={{mr:1}}/>
                    </Box>
