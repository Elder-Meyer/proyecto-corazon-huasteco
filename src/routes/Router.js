...
import { Danza }                from '../views/Tematicas/Danza'
import { Gastronomia }          from '../views/Tematicas/Gastronomia'
import { Musica }               from '../views/Tematicas/Musica'
import { PanelTematicas }       from '../views/Tematicas/PanelTematicas'
import { Tradiciones }          from '../views/Tematicas/Tradiciones'
import { Vestimenta }           from '../views/Tematicas/Vestimenta'
//VISTAS DE PERFILES
import { Administrador }        from '../views/Profiles/Administrador'
import { Colaborador }          from '../views/Profiles/Colaborador'
import { Consultor }            from '../views/Profiles/Consultor'
import { Supervisor }           from '../views/Profiles/Supervisor'
              ...
              <Box sx={{
                ...
                <ScrollToTop>
                  <Routes>
                    ...
                    <Route path='/user/colaborador'   element={<ProtectedRoute>  <Colaborador/>   </ProtectedRoute>} />
                    <Route path='/user/supervisor'    element={<ProtectedRoute>   <Supervisor/>   </ProtectedRoute>} />
                    <Route path='/user/administrador' element={<ProtectedRoute>  <Administrador/> </ProtectedRoute>} />
                    {/* acceso -- registro */}
